...
export const IDEA_FORMS = {
  ...
  "Mat. Stuff": {
    pitch: "a thing that doesn't exist yet? we can probably build it.",
    fields: [
      { key: "build", label: "what to build", ph: "lamp / shelf / something weirder" },
      { key: "specs", label: "dimensions / materials", ph: "rough size, wood / acrylic / etc." },
    ],
  },
  "Music & Sound": {

...
export const DEFAULT_DATA = {
  ...
  categories: [
    { name: "Shirts & Merch", blurb: "wear the brand. small runs, big fits.", tone: "t1", image: "", parentId: null, layout: "standard", isItem: false },
    { name: "Digital Design", blurb: "logos, layouts, album art — you name it.", tone: "t2", image: "", parentId: null, layout: "standard", isItem: false },
    { name: "Mat. Stuff", blurb: "physical builds and objects that actually exist.", tone: "t3", image: "", parentId: null, layout: "standard", isItem: false },
...
export const defaultSpecs = (settings, product) => [
  ...
  { label: "how to get it", value: "reach out below" },
];
...
// Shared "give us your idea" destination for ITEM boxes. Falls back to a
// prefilled email when no link is set.
export const ideaHref = (settings) =>
  (settings?.ideaLink || "").trim() || mailtoHref(settings?.email || "", "an idea");
